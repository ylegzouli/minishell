...
SRC_NAME =	main.c utils2.c pwd.c echo.c parsing_output.c parsing.c init.c exec_cmd.c env.c check_env.c \
			parsing_env.c env_cmd.c parsing_file.c export.c empty_pipe.c echo_suite.c  parsing_env_suite.c \
			free_env.c cd.c cd_dir.c exec_fork.c signal.c utils.c error.c export_no_arg.c free.c parsing_utils.c env_suite.c print_error.c
